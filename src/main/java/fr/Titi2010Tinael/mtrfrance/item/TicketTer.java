...
public class TicketTer {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MTR_France.MOD_ID);

    public static final RegistryObject<Item> Ticket_Ter = ITEMS.register("ticket_ter", () -> new Item(new Item.Properties().tab(MTRFranceCreativeTab.MTRFrance)));
