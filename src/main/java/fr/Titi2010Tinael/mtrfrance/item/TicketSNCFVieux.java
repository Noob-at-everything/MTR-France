...
public class TicketSNCFVieux {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MTR_France.MOD_ID);

    public static final RegistryObject<Item> Ticket_SNCF_Vieux = ITEMS.register("ticket_sncf_vieux", () -> new Item(new Item.Properties().tab(MTRFranceCreativeTab.MTRFrance)));
