...
public class PlanMetroIDFM {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MTR_France.MOD_ID);

    public static final RegistryObject<Item> Plan_Metro_IDFM = ITEMS.register("plan_metro_idfm", () -> new Item(new Item.Properties().tab(MTRFranceCreativeTab.MTRFrance)));
