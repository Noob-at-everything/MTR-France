...
public class NavigoEasy {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MTR_France.MOD_ID);

    public static final RegistryObject<Item> Navigo_Easy = ITEMS.register("navigo_easy", () -> new Item(new Item.Properties().tab(MTRFranceCreativeTab.MTRFrance)));
